...
final contractElectronicProvider = StateNotifierProvider.autoDispose<ContractElectronicProvider, DataState<List<ContractElectronicDto>, ErrorResponse>>(
      (ref) => ContractElectronicProvider(ref),
);

class ContractElectronicProvider extends StateNotifier<DataState<List<ContractElectronicDto>, ErrorResponse>> {
  ContractElectronicProvider(this.ref) : super(NotLoaded<List<ContractElectronicDto>>());
